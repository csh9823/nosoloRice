...
public class BusinessInquiry {
	...
	public String toString() {
		return "BusinessInquiry [businessInquiryNo=" + businessInquiryNo + ", businessDivision=" + businessDivision
				+ ", businessTitle=" + businessTitle + ", businessPicture=" + businessPicture
				+ ", businessInquiryRegDate=" + businessInquiryRegDate + ", businessContent=" + businessContent
				+ ", businessCommentRegDate=" + businessCommentRegDate + ", businessComment=" + businessComment
