		...
		<c:when test="${ overlap }">
            ...
            <div class="row text-center">
              <div class="col">
                ...
                <p class="fs-6">입력하신 ${id}는 이미 사용중인 아이디 입니다.</p>
              </div>       
         	</div>
          ...
          <c:otherwise>
          	<div class="col">
	              ...
	              <div class="col">
	                ...
	                <p class="fs-6">입력하신 ${id}는 사용할 수 있는 아이디 입니다.</p>
	              </div>       
	         	</div>
	         	<div class="row mt-5">
	         		<div class="col text-center">
	         			<input type="button" value="${ id }을(를) 아이디로 사용하기" id="btnIdCheckClose" data-id-value="${ id }" class="btn btn-success" />
	         		</div>
	         	</div>
            </div>
          </c:otherwise>
