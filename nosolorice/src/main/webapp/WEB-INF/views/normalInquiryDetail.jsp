    ...
    <div class="row">
        ...
        <div class="col p-5">
        	...
        	<div class="row py-4 fs-5 border-bottom">
        		...
        		<div class="col fs-5">
        			<fmt:formatDate value="${userInquiry.inquiryRegDate}" pattern="yyyy-MM-dd" />
        		</div>	
        	</div>
        	...
        	<div class="row py-4 fs-5 border-bottom">
        		...
        		<div class="col fs-5" style="min-height:300px;">
					<pre>${userInquiry.inquiryContent}</pre> 
					<br>
					<c:if test="${not empty userInquiry.inquiryPicture}">
						<img src="resources/upload/${userInquiry.inquiryPicture}" style="max-width:100%;">
					</c:if>    		
        		</div>
        	</div>
        	...
        	<div class="row py-4 fs-5">
        		<div class="col text-end">
					...
					<%-- <input type="button" value="답변하기" class="btn asnwerBtn" onclick="location.href='adminNormalInquiryList?pageNum=${pageNum}'"> --%>
        		</div>
        	</div>
        	
        	<form action="answerInquiryProcess" name="answerForm" id="answerForm" method="post">
        	<input type="hidden" value="${userInquiry.userInquiryNo}" id="inquiryNo" name="userInquiryNo">
