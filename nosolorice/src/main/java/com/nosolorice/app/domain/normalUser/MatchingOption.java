...
public class MatchingOption {
	...
	public String toString() {
		return "MatchingOption [normalId=" + normalId + ", matchingCount=" + matchingCount + ", matchingXpoint="
				+ matchingXpoint + ", matchingYpoint=" + matchingYpoint + ", matchingAddress1=" + matchingAddress1
				+ ", matchingDivision=" + matchingDivision + ", matchingCateOption1=" + matchingCateOption1
				+ ", matchingCateOption2=" + matchingCateOption2 + ", matchingCateOption3=" + matchingCateOption3
				+ ", matchingGender=" + matchingGender + ", matchingAge=" + matchingAge + "]";
	}
