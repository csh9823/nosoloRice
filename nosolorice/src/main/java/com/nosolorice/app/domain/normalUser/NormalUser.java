...
public class NormalUser {
	...
	public String toString() {
		return "NormalUser [normalId=" + normalId + ", pass=" + pass + ", name=" + name + ", birth=" + birth
				+ ", nickName=" + nickName + ", mobile=" + mobile + ", profile=" + profile + ", postNum=" + postNum
				+ ", address1=" + address1 + ", address2=" + address2 + ", xpoint=" + xpoint + ", ypoint=" + ypoint
				+ ", gender=" + gender + ", email=" + email + ", regDate=" + regDate + ", myPoint=" + myPoint
				+ ", root=" + root + "]";
	}
