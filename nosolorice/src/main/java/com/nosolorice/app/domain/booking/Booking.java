...
public class Booking {
	...
	public Booking() {};
	public Booking(int bookingNo, int bookingCount, String bookingRequest, Timestamp bookingTime, String bookingState,
			int bookingBookNo, String businessId, String bookingChatName) {
		super();
